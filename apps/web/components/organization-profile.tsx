...
export function ProfileFields({draft,setDraft,section,disabled,documents=[],conditional=false}:{draft:OrganizationProfile;setDraft:(profile:OrganizationProfile)=>void;section:string;disabled:boolean;documents?:ComplianceDocument[];conditional?:boolean}) {
